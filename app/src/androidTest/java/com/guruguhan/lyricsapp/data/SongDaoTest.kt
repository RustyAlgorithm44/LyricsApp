...
class SongDaoTest {
    ...
    fun insertAndGetSong() = runBlocking {
        val song = Song(id = 1, title = "Test Song", composer = "Test Composer", deity = "Test Deity", lyrics = "Test Lyrics", youtubeLink = "youtube.com/test")
        songDao.insert(song)
    ...
    fun getAllSongsSortedByTitleAsc() = runBlocking {
        val song1 = Song(id = 1, title = "B Song", composer = "Composer A", deity = "Deity A", lyrics = "Lyrics B")
        val song2 = Song(id = 2, title = "A Song", composer = "Composer B", deity = "Deity B", lyrics = "Lyrics A")
    ...
    fun getSongCount() = runBlocking {
        ...
        val song1 = Song(id = 1, title = "Song 1", composer = "Composer 1", deity = "Deity 1", lyrics = "Lyrics 1")
        songDao.insert(song1)
        assertEquals(1, songDao.getSongCount())

        val song2 = Song(id = 2, title = "Song 2", composer = "Composer 2", deity = "Deity 2", lyrics = "Lyrics 2")
        songDao.insert(song2)
    ...
    fun searchSongs() = runBlocking {
        val song1 = Song(id = 1, title = "Hello", composer = "Adele", deity = "None", lyrics = "Hello from the other side")
        val song2 = Song(id = 2, title = "World", composer = "Various", deity = "Earth", lyrics = "World of wonders")
        songDao.insert(song1)
        songDao.insert(song2)
    ...
    fun updateSong() = runBlocking {
        val song = Song(id = 1, title = "Original Title", composer = "Original Composer", deity = "Original Deity", lyrics = "Original Lyrics")
        songDao.insert(song)
